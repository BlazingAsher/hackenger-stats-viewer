<template>
  <div id="app">
    ...
    <div class="container-fluid" style="padding-top: 5em; padding-bottom: 1em;">
      ...
      <div class="row">
        <div class="col-lg-12">
          <p class="text-center">MasseyHacks Hackenger Stats Viewer. Copyright &copy; 2020 MasseyHacks.<br><a class="black-link" href="#top" v-smooth-scroll>Back to Top</a> - <a class="black-link" href="https://masseyhacks.ca">Main Site</a></p>
        </div>
      </div>
    </div>
  </div>
